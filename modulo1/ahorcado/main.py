...
def buscar_palabra_aleat(listaPalabras):
    # Esta funcion retorna una palabra aleatoria.
    palabraAleatoria = random.randint(0, len(listaPalabras) - 1)
    return listaPalabras[palabraAleatoria]


def display_board(AHORCADO, letraIncorrecta, letraCorrecta, palabraSecreta):
...
letraIncorrecta = ""
letraCorrecta = ""
palabraSecreta = buscar_palabra_aleat(palabras)
finJuego = False
while True:
    display_board(AHORCADO, letraIncorrecta, letraCorrecta, palabraSecreta)
    ...
    if letra in palabraSecreta:
        ...
        if len(letraIncorrecta) == len(AHORCADO) - 1:
            display_board(AHORCADO, letraIncorrecta,
