...
y testing de aplicaciones. Además tiene una amplia aceptación por científicos
que hacen aplicaciones para las supercomputadores más rápidas del
...
texto2 = texto.replace('Python', 'python', 1)  # solo reemplaza una vez lo
